...
import com.thingrem.adforest.utills.Network.AuthenticationInterceptor;
...
public class UrlController {
    ...
    private static String IP_ADDRESS = "https://thingrem.com/";//Enter You Ip_Address/DomainName here here
    private static String Purchase_code = "ceff2abc-1c75-4b0e-a3ef-9b0e32e545f5";//Enter the purchase code here
    private static String Custom_Security = "9436147189";//Enter the Custom Security code here
